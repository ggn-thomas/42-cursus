...
/*   Updated: 2025/06/28 17:38:28 by thgaugai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->map[(int)player->y][(int)(player->x + player->dir_x * player->move_speed)] == '0')
		player->x += player->dir_x * player->move_speed;	
	if (data->map[(int)(player->y + player->dir_y * player->move_speed)][(int)player->x] == '0')
...
void	ft_leftward(t_player *player, t_data *data)
{
	...
	if (data->map[(int)player->y][(int)(player->x + left_x * player->move_speed)] == '0')
		player->x += left_x * player->move_speed;
	if (data->map[(int)(player->y + left_y * player->move_speed)][(int)player->x] == '0')
...
void	ft_rightward(t_player *player, t_data *data)
{
	...
	if (data->map[(int)player->y][(int)(player->x + right_x * player->move_speed)] == '0')
		player->x += right_x * player->move_speed;
	if (data->map[(int)(player->y + right_y * player->move_speed)][(int)player->x] == '0')
